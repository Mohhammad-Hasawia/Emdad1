...
export default function Activities() {
  ...
  const achievements = [
    {
      icon: Truck,
      number: "12,000+",
      titleEn: "Successful Transport Operations",
      titleAr: "عملية نقل ناجحة"
    },
    {
      icon: MapPin,
      number: "6M+",
      titleEn: "Kilometers Driven",
      titleAr: "كيلومتر مقطوع"
    },
    {
      icon: Users,
      number: "200+",
  ...
  const keyAchievements = [
    ...
    {
      titleEn: "Strategic partnerships with over 50 petroleum companies and service providers",
      titleAr: "شراكات استراتيجية مع أكثر من 50 شركة نفطية ومزود خدمة"
    },
    {
      titleEn: "Specialized transport services for hazardous petroleum cargo in compliance with top environmental and technical safety standards",
      titleAr: "تقديم خدمات نقل مخصصة للبضائع الخطرة وفقًا لأعلى معايير السلامة البيئية والتقنية"
    }
  ];

  const arabicContent = `منذ تأسيس شركة إمداد في عام 2019، ونحن نكرّس جهودنا لتقديم حلول نقل بري متخصصة وآمنة لمختلف المنتجات النفطية والنفط الخام داخل سوريا وفي المنطقة الإقليمية المحيطة. بفضل التزامنا الصارم بالجودة والكفاءة، أصبحت إمداد من أبرز الشركات العاملة في مجال النقل البري النفطي.
...
في شركة إمداد، نؤمن أن النقل الآمن للمواد البترولية مسؤولية كبيرة، ولهذا نواصل الاستثمار في الأسطول والكوادر والتقنيات لضمان أعلى مستويات الأداء والثقة.`;

  const englishContent = `Since its founding in 2019, Emdad has been dedicated to providing safe and specialized land transport solutions for a wide range of petroleum products and crude oil across Syria and the surrounding region. With a firm commitment to quality and efficiency, Emdad has established itself as a leading name in the petroleum ground transport sector.
...
At Emdad, we understand that transporting petroleum products is a critical responsibility. That's why we continue to invest in our fleet, people, and technology to deliver performance and reliability that clients can trust.`;
              ...
              {achievements.map((achievement, index) => (
                <Card key={index} className="text-center p-6 hover:shadow-lg transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                  <CardContent className="pt-6">
                    ...
                    <div className="text-3xl font-bold text-emdad-navy mb-2">
                      {achievement.number}
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="space-y-4">
                  {['Syria', 'Lebanon', 'Jordan', 'Iraq', 'Turkey'].map((country, index) => (
