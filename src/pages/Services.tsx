  ...
  const services = [
    {
      ...
      descriptionEn: "Emdad offers professional and secure crude oil and petroleum product transportation services within Syria and across the regional market.",
      descriptionAr: "تقدم شركة إمداد خدمات نقل النفط الخام ومشتقاته داخل سوريا وفي المحيط الإقليمي، باحترافية وأمان.",
    ...
    },
    {
      ...
      descriptionEn: "Emdad provides full-scale warehouse management solutions. We receive the entire storage site, audit quantities, identify transport needs, and carry out the logistics—all while the client enjoys full hands-off convenience.",
      descriptionAr: "لدى إمداد خدمة متقدمة لإدارة المخازن، حيث تستلم الشركة المخزن بالكامل، تقوم بإحصاء الكميات وتحديد الاحتياجات اللوجستية، وتتكفل بعملية النقل دون تدخل مباشر من صاحب المخزن.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-emdad-navy mb-6">
                {language === 'ar' ? 'أسطولنا في العمل' : 'Our Fleet in Action'}
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="animate-fade-in-up">
                <img 
                  ...
                  alt="Modern Oil Tankers"
                  className="rounded-lg shadow-lg w-full h-64 object-cover"
                />
                <p className="text-center mt-4 text-gray-600 font-medium">
                  {language === 'ar' ? 'صهاريج نفط حديثة' : 'Modern Oil Tankers'}
                </p>
              </div>
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                />
                <p className="text-center mt-4 text-gray-600 font-medium">
                  {language === 'ar' ? 'النقل الإقليمي' : 'Regional Transport'}
                </p>
              </div>
            </div>
          </div>
