...
export default function Safety() {
  ...
  const trainingPrograms = [
    ...
    {
      titleEn: "Hazardous Materials Handling",
      titleAr: "التعامل مع المواد الخطرة"
    },
    {
      titleEn: "Incident Prevention Protocols",
      titleAr: "بروتوكولات منع الحوادث"
    },
    {
      titleEn: "Safety Equipment Usage",
      titleAr: "استخدام معدات السلامة"
    }
  ];

  const arabicContent = `على مدى السنوات، نمت شركة إمداد لتصبح واحدة من أبرز شركات النقل البري المتخصصة في نقل النفط ومشتقاته في سوريا والمنطقة الإقليمية. ومع هذا النمو، تزداد مسؤوليتنا تجاه السلامة، ونحن ملتزمون بالكامل بالحفاظ على أعلى معايير الأمان في جميع عملياتنا.

نلتزم في إمداد بتطبيق وتجاوز المعايير المعترف بها محليًا ودوليًا فيما يتعلق بسلامة النقل البري، خاصة عند التعامل مع المواد القابلة للاشتعال والخطرة. كل عملية نقل تخضع لإجراءات دقيقة تشمل الفحص الفني للمركبات، والتأكد من جاهزية السائقين، وتنفيذ خطط طوارئ مسبقة.
...
في إمداد، السلامة ليست خيارًا، بل هي أساس استمراريتنا وسمعتنا في هذا القطاع الحساس.`;

  const englishContent = `Over the years, Emdad has grown to become one of the leading land transport companies specializing in petroleum and crude oil logistics in Syria and the regional market. With that growth comes great responsibility—and we are fully committed to maintaining the highest safety standards across every operation.

At Emdad, we believe in meeting and exceeding all recognized safety and performance standards, particularly in the handling and transport of flammable and hazardous materials. Every single shipment undergoes strict procedures, including technical inspections, driver preparedness checks, and pre-defined emergency response plans.
...
At Emdad, safety is not optional—it is the foundation of our reliability and reputation in the field of petroleum transport.`;
