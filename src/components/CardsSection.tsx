...
const cards = [
  ...
  },
  {
    key: 'contact',
    icon: Mail,
    image: 'https://images.unsplash.com/photo-1486312338219-ce68e2c6b331?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    href: '/contact'
  },
];
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-6">
                  <CardTitle className="text-emdad-gold text-xl font-bold mb-3">
                    {t(`cards.${card.key}.title`)}
                  </CardTitle>
                  
                  <CardDescription className="text-white text-base leading-relaxed mb-6">
