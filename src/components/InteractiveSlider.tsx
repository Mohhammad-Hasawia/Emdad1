      ...
      <div className="container mx-auto px-4">
        <div className="relative max-w-6xl mx-auto">
              ...
              <div className="absolute inset-0 bg-[#1F3B73] bg-opacity-70 flex items-center justify-center"> {/* Changed color from #1A1F2B to #1F3B73 (Royal Blue) */}
                <div className="text-center max-w-3xl px-6">
                  ...
                  <Button 
                    ...
                    className="bg-emdad-gold hover:bg-yellow-500 text-white px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-300 transform hover:scale-105"
                  >
          ...
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-emdad-gold hover:bg-yellow-500 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg z-10"
          >
          ...
          <button
            onClick={goToNext}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-emdad-gold hover:bg-yellow-500 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg z-10"
          >
